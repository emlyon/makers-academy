...
function doPost( e ) {
    try {
        ...
        var file;
        var filename = params.course + ' documentation';

        // check if documentation file for this course already exists
        ...
        if( files.hasNext() ) {
            ...
            // create file from documentation model file inside course folder
            var model = DriveApp.getFileById( '1daxKOJxGkwkj71PEbshb2fvr61Bo60C2r2NQkqCnFT4' );
