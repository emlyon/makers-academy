...
function doPost( e ) {
    try {
        ...
        var file;
        var filename = params.course + ' toolbox';

        // check if toolbox file for this course already exists
        ...
        if( files.hasNext() ) {
            ...
            // create file from makers toolbox model file inside course folder
            var model = DriveApp.getFileById( '1msgf17kcfbNBAtihnPeG1IEKbc77b0vUPd1KjnWo7u4' );
